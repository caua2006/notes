...
export function NoteCard({note, onNoteDeleted}: NoteCardProps){
    return(
      <Dialog.Root>
         <Dialog.Trigger className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden outline-none relative hover:ring-slate-600 hover:ring-2 focus-visible:ring-2 focus-visible:ring-lime-400'>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Close className='absolute right-0 top-0 bg-slate-800 p-1.5 text-slate-400'>
          ...
          type='button'
            ...
            className='w-full bg-slate-800 py-4 text-center outline-none text-sm text-slate-300 font-medium group'>
